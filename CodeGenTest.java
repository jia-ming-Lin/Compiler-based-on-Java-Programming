...
//		show(program);  //It may be useful useful to show this here if code generation fails
	...
	@Test
	public void booleanLit2() throws Exception {
		String prog = "booleanLit";
	...
	public void booleanLiteral() throws Exception {
		String prog = "booleanLit";
		String input = prog + "{show (true&false|false);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	public void BinaryExpressionLit() throws Exception {
		...
		String input = prog + "{show (0+500+2.5)+(3*1);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;505.5;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void BinaryExpressionLit2() throws Exception {
		String prog = "binaryExpressionLit2";
		String input = prog + "{show (500)*(.5);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;250.0;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void BinaryExpressionLit4() throws Exception {
		String prog = "binaryExpressionLit4";
		String input = prog + "{show 50&40;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;32;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void BinaryExpressionLit9() throws Exception {
		...
		String input = prog + "{show 4.5*3.2+5.8;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;20.2;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void BinaryExpressionLit8() throws Exception {
		...
		String input = prog + "{show (1*2.5)**(3*1)*20;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;312.5;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	@Test
	public void UnaryLit2() throws Exception {
		String prog = "unaryExpressionLit2";
		String input = prog + "{show -(5.5-3);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	@Test
	public void UnaryLit3() throws Exception {
		String prog = "unaryLit3";
	...
	public void UnaryExpressionLit4() throws Exception {
		...
		String input = prog + "{show !(false&false);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	public void testcase1() throws Exception {
		...
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\1.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	}
	@Test
	...
	public void testcase3() throws Exception {
		...
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\1.PNG","C:\\Users\\jiaminglin\\Pictures\\yellow.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	}
	@Test
	...
	@Test
	public void Te00st() throws Exception {
		String prog = "prog";
		String input = prog + "{if(true){ int x; }; int x; x := 5; show x;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
	...
	public void FunctionExpressionWithArgLit() throws Exception {
		String prog = "functionExpressionWiit";
		String input = prog + "{image x; input x from @ 0 ; show x; image y; y := x; show y;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\CLOUD.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	public void FunctionExpressionWithArgLit2() throws Exception {
		...
		String input = prog + "{show cos(50.0);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;0.964966;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void FunctionExpressionWithArgLit3() throws Exception {
		String prog = "functionExpressionWithArgLit3";
		String input = prog + "{show atan(45.0);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;1.5485778;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void FunctionExpressionWithArgLit4() throws Exception {
		String prog = "functionExpressionWithArgLit4";
		String input = prog + "{show log(20.0);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;2.9957323;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void FunctionExpressionWithArgLit5() throws Exception {
		String prog = "functionExpressionWithArgLit5";
		String input = prog + "{show abs(-20.5);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;20.5;leaving main;",RuntimeLog.globalLog.toString());
	}
	@Test
	public void FunctionExpressionWithArgLit97() throws Exception {
		String prog = "functionExpressionWithArgLit5";
		String input = prog + "{show abs(20.5);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
	...
	@Test
	public void FunctionExpressionWithArgLitcdes6() throws Exception {
		String prog = "functionExpressionWithArgLit6";
		String input = prog + "{show cos(-5.0);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;0.2836622;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void FunctionExpressionWithArgLit8() throws Exception {
		...
		String input = prog + "{show alpha(80);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	public void FunctionExpressionWithArgLit9() throws Exception {
		String prog = "functionExpressionWithArgLit8";
		String input = prog + "{show alpha(10);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	@Test
	public void FunctionExpressionWithArgLit80() throws Exception {
		String prog = "functionExpressionWithArgLit9";
		String input = prog + "{show int(-10.0);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	@Test
	public void FunctionPredefinedNameLit5() throws Exception {
		String prog = "functionPredefinedNameLit2";
		String input = prog + "{show default_height;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	@Test
	public void Assign700Test() throws Exception {
		String prog = "AssignmentTest";
		String input = prog + "{int a; a := 10; show a; float b; b := 8.7; show b;boolean T; T:=true; show T;show !T;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;10;8.7;true;false;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void Assignment50() throws Exception {
	...
	public void AssignmentTest3() throws Exception {
		...
		String input = prog + "{boolean a; a := false;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	public void ImageTest() throws Exception {
		...
		String input = prog + "{image i[800, 600]; show width(i);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);
		//waitForKey();
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;800;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void ImageTest3() throws Exception {
		...
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\yellow.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);
		//waitForKey();
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;leaving main;",RuntimeLog.globalLog.toString());
	...
	public void expressionFunctionAppWithPixelTest4() throws Exception {
		...
		String input = prog + "{show polar_r[40, 45];} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;60.207973;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void ifStatementTest() throws Exception {
		String prog = "IfStatementTest";
		String input = prog + "{int i; i := 0; if (i == 0){i := 1; show i;}; show i;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;1;1;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void pixelConstructorTest() throws Exception {
		...
		String input = prog + "{show <<5, 2-0, 1+1, 2>>;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		
		assertEquals("entering main;84017666;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void pixelSelectorTest() throws Exception {
		...
		String input = prog + "{image i; input i from @ 0; show i[300, 100];} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\yellow.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	public void lhsPixelTest() throws Exception {
		...
		String input = prog + "{image i; input i from @ 0; i[200, 400] := 40; show i;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\1.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		//waitForKey();
	...
	public void writeTest() throws Exception {
		...
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\1.PNG", "C:\\Users\\jiaminglin\\Pictures\\2.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	@Test
	public void writeTes12t() throws Exception {
		String prog = "writeTest";
		String input = prog + "{show 50/(1.5+1);} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\1.PNG", "C:\\Users\\jiaminglin\\Pictures\\yellow.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;20.0;leaving main;",RuntimeLog.globalLog.toString());
	}
	...
	public void lhsPixelSampleTest() throws Exception {
		...
		String input = prog + "{image i; input i from @ 0; green(i[500, 200]) := 40; show i;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"C:\\Users\\jiaminglin\\Pictures\\yellow.PNG"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
	...
	public void conditionalExpressionTest() throws Exception {
		...
		String input = prog + "{show 10 == 10 ? 6: 4;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);
		show("Log:\n"+RuntimeLog.globalLog);
