...
public class Declaration extends ASTNode {
	...
	public void set_current_slot(int a){
		this.slot_number=a;
	}
	public int return_slot(){
	...
	public Kind gettype() throws Exception{
		return this.type;
	}
	
	
	public void set_outputtype(Kind type){
		output_type=Types.getType(type);
	}
